<?php
	...
	$diasemanaNombre = date("l");
	if($diasemanaNombre == "Sunday"){
		$diaSemana = 7;
	}else if($diasemanaNombre == "Monday"){
		$diaSemana = 1;
	}else if($diasemanaNombre == "Tuesday"){
		$diaSemana = 2;
	}else if($diasemanaNombre == "Wednesday"){
		$diaSemana = 3;
	}else if($diasemanaNombre == "Thursday"){
		$diaSemana = 4;
	}
	else if($diasemanaNombre == "Friday"){
		$diaSemana = 5;
	}
	else if($diasemanaNombre == "Saturday"){
		$diaSemana = 6;
	}
	...
	$so1=mysqli_query($conexion,"SELECT * FROM ".$table." WHERE menu_id = ".$diaSemana." ");

		
	
	$res=mysqli_fetch_array($so1);
	$id_producto_primero = $res['menu_primero'];
	$id_producto_segundo = $res['menu_segundo'];
	$id_producto_postre = $res['menu_postre'];
	$id_producto_bebida = $res['menu_bebida'];
	
	$result=mysqli_query($conexion,"SELECT * FROM producto WHERE id=".$id_producto_primero." ");
	$res_primero=mysqli_fetch_array($result);
	
	$result=mysqli_query($conexion,"SELECT * FROM producto WHERE id=".$id_producto_segundo." ");
	$res_segundo=mysqli_fetch_array($result);
	
	$result=mysqli_query($conexion,"SELECT * FROM producto WHERE id=".$id_producto_postre." ");
	$res_postre=mysqli_fetch_array($result);
	
	$result=mysqli_query($conexion,"SELECT * FROM producto WHERE id=".$id_producto_bebida." ");
	$res_bebida=mysqli_fetch_array($result);
	...
	<div class="colu col-sm-6 col-md-4 col-lg-3">
		<div class="tot">
			<div class="cont">
				<img class="dip1" src="../media/img/<?php echo $res_primero['imagen']; ?>"/>
				
			</div> 
			<div class="dat">
					<div class="nom">
						<h6 class="neg"><?php echo $res_primero['nombre']; ?></h6>
					</div>
					<h6 class="neg"><?php echo $res_primero['precio']?> € <br> <?php echo $res_primero['cantidad']?> kcal</h6>
			</div>
	...
	<div class="colu col-sm-6 col-md-4 col-lg-3">
		<div class="tot">
			<div class="cont">
				<img class="dip1" src="../media/img/<?php echo $res_segundo['imagen']; ?>"/>
				
			</div>  
			<div class="dat">
					<div class="nom">
						<h6 class="neg"><?php echo $res_segundo['nombre']; ?></h6>
					</div>
					<h6 class="neg"><?php echo $res_segundo['precio']?> € <br> <?php echo $res_segundo['cantidad']?> kcal</h6>
			</div>
	</div>
	</div>
	<div class="colu col-sm-6 col-md-4 col-lg-3">
		<div class="tot">
			<div class="cont">
				<img class="dip1" src="../media/img/<?php echo $res_postre['imagen']; ?>"/>
				
			</div>  
			<div class="dat">
					<div class="nom">
						<h6 class="neg"><?php echo $res_postre['nombre']; ?></h6>
					</div>
					<h6 class="neg"><?php echo $res_postre['precio']?> € <br> <?php echo $res_postre['cantidad']?> kcal</h6>
			</div>
</div>
	</div>
	<div class="colu col-sm-6 col-md-4 col-lg-3">
		<div class="tot">			
			<div class="cont">
				<img class="dip1" src="../media/img/<?php echo $res_bebida['imagen']; ?>"/>
				
			</div>  
			<div class="dat">
					<div class="nom">
						<h6 class="neg"><?php echo $res_bebida['nombre']; ?></h6>
					</div>
					<h6 class="neg"><?php echo $res_bebida['precio']?> € <br> <?php echo $res_bebida['cantidad']?> kcal</h6>
			</div>			
